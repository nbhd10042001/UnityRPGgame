...
public class ShieldManager : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        {
            PlayerStats.Instance.playerInventory.AddItem(shieldCfg.name, shieldCfg.amount);
            ...
            SpawmManager.Instance.ReleaseShield(this, shieldCfg.name);
        }
    }
}
